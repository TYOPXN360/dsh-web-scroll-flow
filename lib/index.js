...
const TYPEWRITER_MODES = ["native", "overlay"];
...
const ScrollFlowSettingsSchema = Schema.object({
	[FOLLOW_MODE_FIELD]: Schema.union([...FOLLOW_MODES]).default(DEFAULT_FOLLOW_MODE),
	[BOUNCE_ENABLED_FIELD]: Schema.boolean().default(true),
	[TYPEWRITER_ENABLED_FIELD]: Schema.boolean().default(true),
	[TYPEWRITER_MODE_FIELD]: Schema.union([...TYPEWRITER_MODES]).default(DEFAULT_TYPEWRITER_MODE)
});
//#endregion
//#region src/index.ts
...
*/
function apply(ctx) {
	ctx.settings.register(settingsNamespace(SCROLL_FLOW_SETTINGS_NAMESPACE), ScrollFlowSettingsSchema);
}
//#endregion
