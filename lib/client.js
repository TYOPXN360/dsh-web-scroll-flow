		...
		*/
		function apply(ctx) {
			...
			ctx.effect(() => {
				...
				style.textContent = ["[data-variant=\"think\"][data-state=\"running\"] [class*=\"summary\"]{scroll-behavior:smooth}", "[data-variant=\"think\"][data-state=\"running\"] [class*=\"thinkBody\"]{scroll-behavior:smooth}"].join("");
				document.head.appendChild(style);
